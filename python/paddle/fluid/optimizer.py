...
class Optimizer(object):
    ...
    def minimize(self,
        ...
        Args:
            ...
            no_grad_set (set, optional): Set of ``Variable``  or ``Variable.name`` that don't need
                to be updated. The default value is None.   
            grad_clip (GradientClipBase, optional): Gradient cliping strategy, which supports three cliping strategy \
                ( :ref:`api_fluid_clip_GradientClipByGlobalNorm` , :ref:`api_fluid_clip_GradientClipByGlobalNorm` ,  \
                :ref:`api_fluid_clip_GradientClipByValue` ). Default value: None, and there is no gradient clipping.
