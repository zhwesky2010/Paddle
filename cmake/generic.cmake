...
function(merge_static_libs TARGET_NAME)
  ...
  if(WIN32) # windows do not support gcc/nvcc combined compiling. Use msvc lib.exe to merge libs.
    ...
    if(${CMAKE_GENERATOR} STREQUAL "Ninja")
      set(cmd lib /OUT:${CMAKE_CURRENT_BINARY_DIR}/lib${TARGET_NAME}.lib ${libfiles})
    else()
      set(cmd lib /OUT:${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_BUILD_TYPE}/lib${TARGET_NAME}.lib ${libfiles})
    endif()
    add_custom_command(TARGET ${TARGET_NAME} POST_BUILD
...
function(cc_library TARGET_NAME)
  ...
  if(cc_library_SRCS)
    ...
    endforeach()
      ...
      if(cc_library_DEPS)
        #foreach(lib ${cc_library_DEPS})
        #  list(APPEND libs_deps ${${lib}_LIB_DEPENDS})
        #endforeach()
        #if(libs_deps)
        #  list(REMOVE_DUPLICATES libs_deps)
        #endif()
        #list(LENGTH cc_library_DEPS cc_library_DEPS_len_1)
        #message("======${TARGET_NAME}==${cc_library_DEPS_len_1}===cc_library_DEPS=========${cc_library_DEPS}====")
        #list(LENGTH cc_library_DEPS cc_library_DEPS_len_2)
        #message("======${TARGET_NAME}==${cc_library_DEPS_len_2}===cc_library_DEPS=========${cc_library_DEPS}====")
        #list(REMOVE_DUPLICATES cc_library_DEPS)
        #list(LENGTH cc_library_DEPS cc_library_DEPS_len_3)
        #message("======${TARGET_NAME}==${cc_library_DEPS_len_3}===cc_library_DEPS=========${cc_library_DEPS}====")
        #  set(dummyfile ${CMAKE_CURRENT_BINARY_DIR}/${TARGET_NAME}.c)
  ...
  if (WITH_GPU)
    ...
    if(nv_library_SRCS)
      ...
      if (nv_library_DEPS)
        ...
        #list(LENGTH cc_library_DEPS cc_library_DEPS_len_1)
        #message("======${TARGET_NAME}==${cc_library_DEPS_len_1}===cc_library_DEPS=========${cc_library_DEPS}====")
        #list(APPEND cc_library_DEPS ${libs_deps})
        #list(LENGTH cc_library_DEPS cc_library_DEPS_len_2)
        #message("======${TARGET_NAME}==${cc_library_DEPS_len_2}===cc_library_DEPS=========${cc_library_DEPS}====")
        #list(REMOVE_DUPLICATES cc_library_DEPS)
        #list(LENGTH cc_library_DEPS cc_library_DEPS_len_3)
